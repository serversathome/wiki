...
## Cant communicate with the nvidia driver. Make sure the latesr nvidia driver is installed and running
Go to **Apps → Configuration → Settings** and check the box for *Install NVIDIA Drivers*